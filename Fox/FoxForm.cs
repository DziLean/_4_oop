...
namespace _3_oop
{
    public partial class FoxForm : Form
    {
        public FoxForm()
        {
            InitializeComponent();
    ...
    {
        public static Fox ValidateFox(string name, string age, bool CanFly, string wings)
        {
            ...
            return new Fox(na.Value, int.Parse(ag.Value), CanFly, int.Parse(wi.Value), true);
